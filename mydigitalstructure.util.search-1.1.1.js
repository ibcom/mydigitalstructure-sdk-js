...
mydigitalstructure._util.factory.search = function (param)
{
							...
							'<div class="card">',
								'<div class="card-header">',
									'<div class="float-right" data-html2canvas-ignore="true">',
										(context!=undefined?'<button class="myds-click btn btn-white btn-sm" role="button" data-source="close" data-controller="' + context + '">' +
				                     ...
				                     '<button class="myds-click btn btn-white btn-sm ml-2" role="button" data-controller="util-view-search-export"',
				                     	' data-filename="', filename, '">',
			              				...
			              				'</button>',
			              				(search.chart?'<button class="myds-click btn btn-white btn-sm" role="button" data-controller="util-view-search-chart-show" data-selector="' + search.selector + '">' +
	...
	app.add(
	{
		...
		{	
			console.log(param);
			//like in dashboard
			app.invoke('util-view-search-chart-render')
		}
	});
	...
	app.add(
	{
		...
		{	
			...
			var fields = app._util.param.get(search, 'fields', {default: {}}).value;
