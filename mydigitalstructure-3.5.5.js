							...
							$.ajax(
							{
								...
								success: function(data) 
								{
									...
									else
									{
										...
										{
											var role = mydigitalstructure._scope.user.roles.rows[0].title.toLowerCase();
...
mydigitalstructure._util.imageToBase64Data = function (param)
{
	...
	var imageType = mydigitalstructure._util.param.get(param, 'imageType').value;
	var attachmentLink = mydigitalstructure._util.param.get(param, 'attachmentLink').value;
   	...
   	var svgHTML = svg
		...
		image.style.width = width + 'px';
	 	...
	 	image.onload = function()
	 	{
			...
			$('#' + elementImageContainerID + '-png').html('<img src="' + canvasdata + '">');
			mydigitalstructure._util.onComplete(param);
		};
	}	
}
